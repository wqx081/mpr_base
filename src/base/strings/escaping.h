...
// them with "base::". Of course you may also use "using" statements
// within a .cc file.
//
...
#ifndef BASE_STRINGS_ESCAPING_H_
#define BASE_STRINGS_ESCAPING_H_
...
using base::EscapeStrForCSV;
using base::UnescapeCEscapeSequences;
using base::UnescapeCEscapeString;
using base::CEscapeString;
using base::CHexEscapeString;
using base::CEscape;
using base::CHexEscape;
using base::BackslashEscape;
using base::BackslashUnescape;
using base::QuotedPrintableUnescape;
using base::QEncodingUnescape;
using base::Base64Unescape;
using base::WebSafeBase64Unescape;
using base::CalculateBase64EscapedLen;
using base::Base64Escape;
using base::WebSafeBase64Escape;
using base::WebSafeBase64EscapeWithPadding;
using base::Base32Escape;
using base::Base32HexEscape;
using base::CalculateBase32EscapedLen;
using base::EightBase32DigitsToTenHexDigits;
using base::TenHexDigitsToEightBase32Digits;
using base::EightBase32DigitsToFiveBytes;
using base::FiveBytesToEightBase32Digits;
using base::int_to_hex_digit;
using base::int_to_lower_hex_digit;
using base::hex_digit_to_int;
using base::a2b_hex;
using base::a2b_bin;
using base::b2a_hex;
using base::b2a_bin;
using base::ShellEscape;
using base::ShellEscapeCommandLine;
using base::ByteStringFromAscii;
using base::ByteStringToAscii;
using base::CleanStringLineEndings;

#endif  // BASE_STRINGS_ESCAPING_H_
