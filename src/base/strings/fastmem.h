...
//   base::fastmemcmp_inlined() replaces memcmp()
//   base::memcpy_inlined() replaces memcpy()
//   base::memeq(a, b, n) replaces memcmp(a, b, n) == 0
//
// base::*_inlined() routines are inline versions of the
// routines exported by this module.  Sometimes using the inlined
// versions is faster.  Measure before using the inlined versions.
//
// Performance measurement:
//   base::fastmemcmp_inlined
//     Analysis: memcmp, fastmemcmp_inlined, fastmemcmp
//     2012-01-30

#ifndef BASE_STRINGS_FASTMEM_H_
#define BASE_STRINGS_FASTMEM_H_
